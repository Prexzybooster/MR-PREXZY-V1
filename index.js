...
var session = conf.session.replace(/MR-PREXZY-V1-WHATSAPP-BOT;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['MR-PREXZY-V1', "safari", "1.0.0"],
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '2349159895444';
            const dj2 = '2349159895444';
            const dj3 = "2349159895444";
            const luffy = '2348086541281';
